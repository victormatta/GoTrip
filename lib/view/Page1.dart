...
import 'package:country_app/view/Europe.dart';
import 'package:country_app/widgets/card.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Page1 extends StatelessWidget {
  static final Key southAmericaKey = UniqueKey();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      endDrawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              title: const Text('Central America'),
              onTap: () {
                Get.to(context);
              },
            ),
      ...
      body: RealTripSouthAmerica(key: Page1.southAmericaKey),
    );
  }
}

class RealTripSouthAmerica extends StatelessWidget {
  final controller = Get.put(CountryController());

  RealTripSouthAmerica({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: controller.southAmericaList(),
